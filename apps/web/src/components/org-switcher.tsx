    ...
    <div ref={ref} style={{ position: "relative" }}>
      ...
      {open && (
        <div style={{
          ...
          zIndex: 100, minWidth: 280, maxHeight: 360, overflow: "hidden",
          ...
          <div style={{ overflowY: "auto", flex: 1 }}>
            {loading ? (
              ...
              <p style={{ padding: 16, fontSize: 13, color: "var(--color-text-secondary)", textAlign: "center" }}>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    padding: "10px 14px", background: isActive ? "var(--color-background-secondary)" : "none",
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <p style={{ fontSize: 13, fontWeight: 500, margin: "0 0 2px", color: isActive ? "#534AB7" : "var(--color-text-primary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {org.displayName ?? org.name}
                    </p>
                    <p style={{ fontSize: 11, color: "var(--color-text-secondary)", margin: 0 }}>
                      {org.organizationTier ?? org.organizationType ?? "church"}
                    </p>
                  </div>
