...
export function CapacitacaoStoreView() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setEntitledIds(
        new Set(
          ents.filter((e) => e.status === "active").map((e) => e.programId),
        ),
      );
    } catch (e) {
  ...
  return (
    <div style={{ padding: "2rem 1.5rem", maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ marginBottom: 24 }}>
        ...
        >
          Capacite a liderança da sua igreja
        </h1>
        <p
          style={{
            fontSize: 14,
        ...
        >
          Trilhas de formação produzidas pela Plataforma Esdras. Ao adquirir,
          todos os membros da sua igreja ganham acesso.
        </p>
      </div>
...
function ProgramPlayer({
  ...
  const { user, organizationId, firebaseConfig, configured, firebaseReady } =
    useAppAuth();
  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      try {
        ...
        const existing =
          ready && user
            ? await fetchMemberCourseProgress(
                firebaseConfig,
                { organizationId },
                user.uid,
                program.id,
    ...
    <div style={{ padding: "1.5rem", maxWidth: 1100, margin: "0 auto" }}>
      ...
      >
        <div>
          ...
          >
            {pct}% concluído · {completedCount}/{lessons.length} aulas
          </p>
          ...
          {activeLesson ? (
            <>
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...primaryBtn,
                    background: progress?.completedLessons.includes(
                      activeLesson.id,
                    )
                      ? "#10b981"
                      : "#534AB7",
              ...
              {activeLesson.content ? (
                <div
                  style={{
                    ...
                    border: "0.5px solid var(--alvo-border, #e2e8f0)",
                  }}
                >
                  <p
                    style={{
            ...
            <p style={{ fontSize: 14, color: "var(--alvo-ink-soft, #64748b)" }}>
          ...
          {done && (
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div>
                  <strong
                    style={{ fontSize: 14, color: "#085041", display: "block" }}
                  >
                    Trilha concluída!
                  </strong>
                  <span style={{ fontSize: 12, color: "#085041" }}>
                    Certificado de {program.title} disponível.
                  </span>
                </div>
              </div>
              <button
