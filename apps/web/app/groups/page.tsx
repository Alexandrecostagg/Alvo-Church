...
export default function GroupsPage() {
  ...
  return (
    <main className="form-page groups-page">
      <ModuleNav />
      <section className="groups-hero">
        ...
        <aside className="groups-status-card">
          <Waypoints size={24} />
      ...
      <section className="groups-workbench">
        <aside className="groups-list-panel">
          ...
          <div className="group-card-list">
            <div className="quick-group-form">
  ...
  return members
    .map((member) => {
      ...
      if (
        ...
        const message = `Ola, ${getFirstName(personName)}! Que alegria ter voce caminhando com a celula. Como foi o encontro para voce? Queremos te ajudar nos proximos passos.`;
