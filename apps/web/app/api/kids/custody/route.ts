...
import { assignGuardians, createKids, familyGuardians, releaseKids } from "../../_lib/kids-custody";
export async function POST(req: NextRequest) {
  try {
    ...
    const operation = body.action === "check_in" ? createKids : body.action === "guardians" ? assignGuardians : body.action === "family_guardians" ? familyGuardians : body.action === "check_out" ? releaseKids : null;
