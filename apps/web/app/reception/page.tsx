    ...
    <main className="form-page reception-page">
      ...
      <section className="reception-command-grid">
        ...
        <article className="reception-route-card">
          ...
          {lastCreated ? (
            <div className="reception-success-card">
              <strong>{lastCreated.name}</strong>
              <p>
                {lastCreated.status}. {lastCreated.journeyId ? `Jornada ${lastCreated.journeyId}` : "Jornada local preparada"}.
              </p>
              {lastCreated.personId ? (
                <Link className="ghost-button" href={`/members/${lastCreated.personId}`}>
                  Abrir ficha criada
                </Link>
              ) : null}
            </div>
