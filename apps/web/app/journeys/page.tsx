...
export default function JourneysPage() {
  ...
  return (
    <main className="form-page journeys-page">
      <ModuleNav />
      <section className="journeys-hero">
        ...
        <aside className="journey-health-card">
...
function getCareScript({
  ...
  if (recommendation?.kind === "status") {
    return `Ola, ${firstName}! Estamos felizes com sua caminhada na Getro Church. A lideranca quer conversar com voce sobre os proximos passos de membresia e participacao. Podemos combinar um melhor horario?`;
  }
