...
describe('Firebase Paths Builder', () => {
  ...
  it('generates correct path for getTenantScopedDocumentPath', () => {
    const result = paths.getTenantScopedDocumentPath(context, 'test-collection', 'test-documentId');
    expect(result).toBe('organizations/org-123/test-collection/test-documentId');
  });
  ...
  it('generates correct path for getOrganizationBrandAssetPath', () => {
    const result = paths.getOrganizationBrandAssetPath(context, 'logoLight', 'test-fileName');
    expect(result).toBe('organizations/org-123/branding/logoLight/test-fileName');
  });
  ...
  it('generates correct path for getFamilyMembersCollectionPath', () => {
    const result = paths.getFamilyMembersCollectionPath(context, 'test-familyId');
  ...
  it('generates correct path for getCommunityOffersCollectionPath', () => {
    const result = paths.getCommunityOffersCollectionPath(context, 'test-storeId');
    expect(result).toBe('organizations/org-123/communityStores/test-storeId/offers');
  });
  ...
  it('generates correct path for getGroupMeetingsCollectionPath', () => {
    const result = paths.getGroupMeetingsCollectionPath(context, 'test-groupId');
  ...
  it('generates correct path for getGroupAttendanceCollectionPath', () => {
    const result = paths.getGroupAttendanceCollectionPath(context, 'test-groupId', 'test-meetingId');
    expect(result).toBe('organizations/org-123/groups/test-groupId/meetings/test-meetingId/attendance');
  });
  ...
  it('generates correct path for getEventRegistrationsCollectionPath', () => {
    const result = paths.getEventRegistrationsCollectionPath(context, 'test-eventId');
    expect(result).toBe('organizations/org-123/events/test-eventId/registrations');
  });

  it('generates correct path for getEventCheckInsCollectionPath', () => {
    const result = paths.getEventCheckInsCollectionPath(context, 'test-eventId');
  ...
  it('generates correct path for getJourneyMissionsCollectionPath', () => {
    const result = paths.getJourneyMissionsCollectionPath(context, 'test-journeyProfileId');
    expect(result).toBe('organizations/org-123/journeyProfiles/test-journeyProfileId/missions');
  });
  ...
  it('generates correct path for getMemberBadgesCollectionPath', () => {
    const result = paths.getMemberBadgesCollectionPath(context, 'test-personId');
  ...
  it('generates correct path for getTribeAssessmentScoresCollectionPath', () => {
    const result = paths.getTribeAssessmentScoresCollectionPath(context, 'test-assessmentId');
    expect(result).toBe('organizations/org-123/tribeAssessments/test-assessmentId/scores');
  });
  ...
  it('generates correct path for getMemberTribeHistoryCollectionPath', () => {
    const result = paths.getMemberTribeHistoryCollectionPath(context, 'test-personId');
    expect(result).toBe('organizations/org-123/people/test-personId/tribeHistory');
  });
  ...
  it('generates correct path for getPlatformProgramModulesCollectionPath', () => {
    const result = paths.getPlatformProgramModulesCollectionPath('test-programId');
  ...
  it('generates correct path for getPlatformProgramLessonsCollectionPath', () => {
    const result = paths.getPlatformProgramLessonsCollectionPath('test-programId');
  ...
  it('generates correct path for getCourseModulesCollectionPath', () => {
    const result = paths.getCourseModulesCollectionPath(context, 'test-courseId');
  ...
  it('generates correct path for getMemberCourseProgressCollectionPath', () => {
    const result = paths.getMemberCourseProgressCollectionPath(context, 'test-memberId');
    expect(result).toBe('organizations/org-123/people/test-memberId/courseProgress');
  });
